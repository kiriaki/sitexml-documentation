...
<xsl:stylesheet 
    ...
    xmlns:doc="https://www.orfeus-eu.org/xml/site/documentation"
    xmlns:html="http://www.w3.org/1999/xhtml" 
    xmlns:xsd="http://www.w3.org/2001/XMLSchema" 
    xmlns:ppp="http://titanium.dstc.edu.au/xml/xs3p" 
    version="1.0" 
    exclude-result-prefixes="xsd ppp html doc">
        ...
        <ul>
            ...
            <xsl:if test="xsd:element">
                <li class="toc-section">
                    <span class="toc-heading">Root and Global Elements</span>
                    <ul>
                        <xsl:choose>
                            <xsl:when test="normalize-space(translate($sortByComponent,'TRUE','true'))='true'">
            ...
            <xsl:if test="xsd:complexType">
                <li class="toc-section">
                    <span class="toc-heading">Complex Types</span>
                    <ul>
                        <xsl:apply-templates select="xsd:complexType[@name='RootType']" mode="toc"/>
                        <xsl:if test="xsd:complexType[@name='SiteOwnerType']">
                            <xsl:apply-templates select="xsd:complexType[@name='SiteOwnerType']" mode="toc"/>
                            <li class="toc-subsection">
                                <ul>
                                    <xsl:apply-templates select="xsd:complexType[@name='ContactType']" mode="toc"/>
                                    <xsl:apply-templates select="xsd:complexType[@name='PersonType']" mode="toc"/>
                                    <xsl:apply-templates select="xsd:complexType[@name='AffiliationType']" mode="toc"/>
                                    <xsl:apply-templates select="xsd:complexType[@name='InstitutionType']" mode="toc"/>
                                    <xsl:apply-templates select="xsd:complexType[@name='PostalAddressType']" mode="toc"/>
                                    <xsl:apply-templates select="xsd:complexType[@name='CountryType']" mode="toc"/>
                                </ul>
                            </li>
                        </xsl:if>
                        <xsl:if test="xsd:complexType[@name='SiteDescriptionType']">
                            <xsl:apply-templates select="xsd:complexType[@name='SiteDescriptionType']" mode="toc"/>
                            <li class="toc-subsection">
                                <ul>
                                    <xsl:apply-templates select="xsd:complexType[@name='SiteMorphologyType']" mode="toc"/>
                                    <xsl:apply-templates select="xsd:complexType[@name='SiteTopographyType']" mode="toc"/>
                                    <xsl:apply-templates select="xsd:complexType[@name='EC8IndicatorType']" mode="toc"/>
                                    <xsl:apply-templates select="xsd:complexType[@name='BedrockDepthIndicatorType']" mode="toc"/>
                                    <xsl:apply-templates select="xsd:complexType[@name='H800IndicatorType']" mode="toc"/>
                                    <xsl:apply-templates select="xsd:complexType[@name='GeologicalUnitIndicatorType']" mode="toc"/>
                                </ul>
                            </li>
                        </xsl:if>
                        <xsl:if test="xsd:complexType[@name='AnalysisType']">
                            <xsl:apply-templates select="xsd:complexType[@name='AnalysisType']" mode="toc"/>
                            <li class="toc-subsection">
                                <ul>
                                    <xsl:apply-templates select="xsd:complexType[@name='ResonanceFrequencyIndicatorType']" mode="toc"/>
                                    <xsl:apply-templates select="xsd:complexType[@name='VelocityS30IndicatorType']" mode="toc"/>
                                    <xsl:apply-templates select="xsd:complexType[@name='VelocityProfileSetIndicatorType']" mode="toc"/>
                                    <xsl:apply-templates select="xsd:complexType[@name='VelocityProfile']" mode="toc"/>
                                    <xsl:apply-templates select="xsd:complexType[@name='VelocityProfileData']" mode="toc"/>
                                    <xsl:apply-templates select="xsd:complexType[@name='LayerGeometry']" mode="toc"/>
                                </ul>
                            </li>
                        </xsl:if>
                        <xsl:apply-templates
                            select="xsd:complexType[
                                @name!='RootType' and
                                @name!='SiteOwnerType' and
                                @name!='ContactType' and
                                @name!='PersonType' and
                                @name!='AffiliationType' and
                                @name!='InstitutionType' and
                                @name!='PostalAddressType' and
                                @name!='CountryType' and
                                @name!='SiteDescriptionType' and
                                @name!='SiteMorphologyType' and
                                @name!='SiteTopographyType' and
                                @name!='EC8IndicatorType' and
                                @name!='BedrockDepthIndicatorType' and
                                @name!='H800IndicatorType' and
                                @name!='GeologicalUnitIndicatorType' and
                                @name!='AnalysisType' and
                                @name!='ResonanceFrequencyIndicatorType' and
                                @name!='VelocityS30IndicatorType' and
                                @name!='VelocityProfileSetIndicatorType' and
                                @name!='VelocityProfile' and
                                @name!='VelocityProfileData' and
                                @name!='LayerGeometry'
                            ]" mode="toc"/>
                    </ul>
                </li>
            ...
            <xsl:if test="xsd:simpleType">
                <li class="toc-section">
                    <span class="toc-heading">Simple Types</span>
                    <ul>
                        <xsl:choose>
                            <xsl:when test="normalize-space(translate($sortByComponent,'TRUE','true'))='true'">
            ...
            <xsl:if test="xsd:group">
                <li class="toc-section">
                    <span class="toc-heading">Model Groups</span>
                    <ul>
                        <xsl:choose>
                            <xsl:when test="normalize-space(translate($sortByComponent,'TRUE','true'))='true'">
            ...
            <xsl:if test="xsd:attribute">
                <li class="toc-section">
                    <span class="toc-heading">Global Attributes</span>
                    <ul>
                        <xsl:choose>
                            <xsl:when test="normalize-space(translate($sortByComponent,'TRUE','true'))='true'">
            ...
            <xsl:if test="xsd:attributeGroup">
                <li class="toc-section">
                    <span class="toc-heading">Attribute Groups</span>
                    <ul>
                        <xsl:choose>
                            <xsl:when test="normalize-space(translate($sortByComponent,'TRUE','true'))='true'">
            ...
            <xsl:if test="xsd:notation">
                <li class="toc-section">
                    <span class="toc-heading">Notations</span>
                    <ul>
                        <xsl:choose>
                            <xsl:when test="normalize-space(translate($sortByComponent,'TRUE','true'))='true'">
    ...
    */
    ...
    <xsl:template match="xsd:appinfo | xsd:documentation" mode="properties">
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <xsl:apply-templates select="node()" mode="docContent"/>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:if test="@source">
            ...
            <xsl:text> For more information, see: </xsl:text>
            <xsl:choose>
                <xsl:when test="@doc:sourceLabel">
                    <a href="{normalize-space(@source)}" target="_blank" rel="noopener noreferrer">
                        <xsl:value-of select="normalize-space(@doc:sourceLabel)"/>
                    </a>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:call-template name="PrintURI">
    ...
    <!--
        ...
        complex type definition.
        -->
    <xsl:template match="xsd:element" mode="element-properties-row">
        <tr>
            <td><xsl:value-of select="@name"/></td>
            <td>
                <xsl:choose>
    ...
    <xsl:template match="xsd:element" mode="choice-element-properties-row">
        <xsl:variable name="elementName" select="@name"/>
        <xsl:variable name="choiceElements"
            select="ancestor::xsd:choice[1]//xsd:element[@name=$elementName]"/>
        <tr>
            <td><xsl:value-of select="@name"/></td>
            <td>
                <xsl:choose>
            ...
            <td>
                <xsl:choose>
                    <xsl:when test="$choiceElements[number(@minOccurs) = 0] and $choiceElements[not(number(@minOccurs) = 0)]">
                        depends on choice branch
                    </xsl:when>
                    <xsl:when test="$choiceElements[number(@minOccurs) = 0]">
                        optional
                    </xsl:when>
                    <xsl:otherwise>
                        <span style="color:red;">required</span>
                ...
                <xsl:if test="$choiceElements[number(@maxOccurs) > 1 or @maxOccurs = 'unbounded']">
                    , many
                </xsl:if>
            </td>
            <td>
    ...
    <xsl:template match="xsd:complexType" mode="properties">
        ...
        <xsl:if test=".//xsd:sequence | .//xsd:choice | .//xsd:all | .//xsd:element">
            ...
            <table class="element-properties">
                ...
                <xsl:for-each select="xsd:sequence/xsd:element | xsd:all/xsd:element | xsd:element">
                    <xsl:apply-templates select="." mode="element-properties-row"/>
                </xsl:for-each>
                <xsl:for-each select="xsd:choice">
                <tr>
                    <td colspan="4">
                        Choice: one of the following branches must be selected
                    </td>
                </tr>
                <xsl:for-each select="xsd:*">
                <tr>
                    <td colspan="4">
                        Choice branch <xsl:number value="position()" format="1"/>
                    </td>
                </tr>
                <xsl:choose>
                ...
                <xsl:for-each select=".//xsd:group[@ref]">
                ...
                <xsl:for-each select="key('group', normalize-space($grpName))//xsd:element">
                <tr>
                    <td>
                        <xsl:value-of select="@name"/>
                    </td>
    ...
    <xsl:template match="xsd:choice" mode="sample">
        ...
        <xsl:if test="normalize-space(@maxOccurs)!='0'">
            ...
            <!-- Content -->
            <xsl:for-each select="xsd:*">
                <span class="group" style="margin-left: {number($margin)+number($ELEM_INDENT)}em">
                    <xsl:text>Choice branch </xsl:text>
                    <xsl:number value="position()" format="1"/>
                </span><br/>
                <xsl:apply-templates select="." mode="sample">
                    <xsl:with-param name="margin" select="number($margin)+(2 * number($ELEM_INDENT))"/>
                    <xsl:with-param name="isInherited" select="$isInherited"/>
                    <xsl:with-param name="isNewField" select="$isNewField"/>
        ...
        <xsl:if test="normalize-space(translate($useJavaScript,'TRUE','true'))='true' and $component and $component/xsd:annotation/xsd:documentation">
            <xsl:variable name="documentation">
                ...
                <!-- Check for two dashes, which will break the JavaScript 
                        code -->
                <xsl:if test="contains(., '--') or contains(@source, '--') or contains(@doc:sourceLabel, '--')">
                    <xsl:call-template name="HandleError">
                        <xsl:with-param name="isTerminating">true</xsl:with-param>
                        <xsl:with-param name="errorMsg">
    ...
    <!--
        Renders markup embedded in xs:documentation as XHTML without copying
        schema-level namespace declarations into the generated HTML.
        -->
    <xsl:template match="*" mode="docContent">
        <xsl:choose>
            <xsl:when test="local-name(.)='p' and (starts-with(normalize-space(.), 'Note:') or starts-with(normalize-space(.), 'Note ') or *[local-name(.)='strong'][1][starts-with(normalize-space(.), 'Note')])">
                <div class="doc-note">
                    <xsl:apply-templates select="node()" mode="docContent"/>
                </div>
            </xsl:when>
            <xsl:when test="local-name(.)='p' and (starts-with(normalize-space(.), 'Example:') or starts-with(normalize-space(.), 'Example ') or *[local-name(.)='strong'][1][starts-with(normalize-space(.), 'Example')])">
                <div class="doc-example">
                    <xsl:apply-templates select="node()" mode="docContent"/>
                </div>
            </xsl:when>
            <xsl:when test="local-name(.)='strong' and starts-with(normalize-space(.), 'Note')">
                <strong class="doc-note-label">
                    <xsl:apply-templates select="node()" mode="docContent"/>
                </strong>
            </xsl:when>
            <xsl:when test="local-name(.)='strong' and starts-with(normalize-space(.), 'Example')">
                <strong class="doc-example-label">
                    <xsl:apply-templates select="node()" mode="docContent"/>
                </strong>
            </xsl:when>
            <xsl:otherwise>
    ...
    <xsl:template match="text()" mode="docContent">
        <xsl:value-of select="."/>
    </xsl:template>

    <xsl:template match="comment()" mode="docContent">
        <xsl:copy/>
    </xsl:template>
    ...
    <xsl:template name="PrintURI">
        ...
        <xsl:choose>
            <xsl:when test="starts-with($uri, 'http')">
                <a title="{$uri}" href="{$uri}" target="_blank" rel="noopener noreferrer">
